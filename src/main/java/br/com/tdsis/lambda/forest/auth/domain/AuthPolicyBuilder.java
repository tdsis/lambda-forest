...
public class AuthPolicyBuilder {
    ...
    public AuthPolicyBuilder denyAll() {
        ...
        PolicyStatement denied = policyStatement(AuthPolicy.ACTION_INVOKE, AuthPolicy.DENY, deniedArn);
     ...
     */
    private PolicyStatement policyStatement(String action, String effect, String resource) {
